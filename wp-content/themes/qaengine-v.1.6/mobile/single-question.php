...
<div class="wrapper-mobile">
    ...
    ?>
        <div class="sticky-wrapper">
            <h3 style="background: #E5E5E5; padding: 15px; font-size: 1.2em; text-align: center"><a class="login-url" href="<?php echo get_site_url() . '/intro?redirect=' . $permalink; ?>"><?php _e('Login or Register to view and post answer',ET_DOMAIN);?></a></h3>
        </div>
    <?php } ?>
