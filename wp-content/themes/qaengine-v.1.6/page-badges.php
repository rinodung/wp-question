...
?>
    ...
    <div class="col-md-8 main-content">
        ...
        <div class="row badges-system">
            ...
            <?php
                $pack_instance = QA_Pack::get_instance();
                $badges     =   $pack_instance->query(array());
            ...
            <div class="col-md-12 badge-content">
                <div class="border">
                    ...
                    <div class="col-md-4">
                        <span><?php _e("You can:", ET_DOMAIN) ?></span>
                        <p>
                        ...
                        <p>
                            ...
                            <?php
                                $vote_down = abs( $badge_points->vote_down ? $badge_points->vote_down : 0 );
                                printf(__("Vote down (costs %s point on answers and questions)", ET_DOMAIN), $vote_down);
                            ?>
                        </p>
                    </div>
                    <div class="col-md-3">
