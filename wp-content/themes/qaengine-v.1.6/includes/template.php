				...
				<div class="row">
					...
					<div class="col-md-5 col-sm-6 col-xs-6">
						<ul class="q-f-sort">
		                    ...
		                    <li>
		                        <a class="<?php echo isset($_GET['sort']) && $_GET['sort'] == 'vote' ? 'active' : ''; ?>" href="<?php echo esc_url(add_query_arg(array('sort' => 'vote'))); ?>">
		                        	<?php _e("Votes",ET_DOMAIN) ?>
		                        </a>
		                    </li>
		                    <li>
		                        <a class="<?php echo isset($_GET['sort']) && $_GET['sort'] == 'unanswer' ? 'active' : ''; ?>" href="<?php echo esc_url(add_query_arg(array('sort' => 'unanswer'))); ?>">
            ...
            <div class="col-md-6 col-xs-6 sort-questions">
                <ul>
                    ...
                    <li>
                    	...
                    	?>
                        <a class="<?php echo isset($_GET['sort']) && $_GET['sort'] == 'unanswer' ? 'active' : ''; ?>" href="<?php echo add_query_arg(array('sort' => 'unanswer'), is_page_template( 'page-pending.php' ) ? home_url() : $new_url); ?>"><?php _e("Unanswered",ET_DOMAIN) ?></a>
                    </li>
                    <?php
                    	global $current_user;
