    ...
    */
    ...
    function render( $first  =   false) {
        ...
        */
        ...
        $qa_pack = QA_Pack::get_instance();
        $badges	= $qa_pack->query(array());
        $pack_list	=	array();

    	echo '<div '. $display .' class="et-main-main clearfix inner-content pack-control '. $this->field['class'] .'" id="'. $this->field['id'] .'"  data-option-name="payment_package" data-template="payment_package" >';
    ?>
			...
			<!-- <div class="inner"> -->
				<div id="payment_lists">
					<ul class="pay-plans-list">	
						...
						<script type="application/json" id="ae_list_payment_package">
				...
				<script type="text/template" id="ae-template-payment_package">
    ...
    function render_menu ( $first =  false ) {
        ...
        if( isset( $this->field['title'] )) {
            ...
            echo '<li>
                <a href="#section/'. $this->field['id'] .'" menu-data="" class="section-link '. $class .'">
