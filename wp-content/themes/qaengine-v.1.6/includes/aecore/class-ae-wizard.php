    ...
    public function notice_after_installing_theme(){
        ...
        ?>
            ...
            <div id="notice_wizard" class="et-updated">
                <p>
                    <?php 
                    $msg = apply_filters( 'notice_after_installing_theme', sprintf( __("You have just installed DirectoryEngine theme, we recommend you follow through our <a href='%s'>setup wizard</a> to set up the basic configuration for your website! <a href='%s'>Close this message</a>", ET_DOMAIN), admin_url('admin.php?page=et-wizard'), add_query_arg('close_notices', '1')));
                    echo $msg;
                    ?>
                </p>
            </div>
