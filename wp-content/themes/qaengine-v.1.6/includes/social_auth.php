...
abstract class ET_SocialAuth extends AE_Base{
	...
	public function enqueue_scripts(){
		if ( is_page_template( 'page-social-connect.php' ) ){
			$this->add_script('et-authentication', TEMPLATEURL . '/js/authentication.js', array('jquery', 'underscore', 'backbone', 'appengine'));
...
class ET_TwitterAuth extends ET_SocialAuth{
	...
	public function __construct(){
		...
		$this->oauth_callback 		= add_query_arg( 'action', 'twitterauth_callback', home_url( ));
...
class ET_FaceAuth extends ET_SocialAuth{
	...
	public function auth_facebook(){
		try {
			...
			$fb_appID      = ae_get_option('et_facebook_key');
			$fb_secret_key = ae_get_option('et_facebook_secret_key');
