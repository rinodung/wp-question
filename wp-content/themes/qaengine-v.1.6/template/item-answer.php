        ...
        <div class="col-md-8 col-xs-8 question-cat">
            <a href="<?php echo get_author_posts_url($qa_answer->post_author); ?>">
                <span itemprop="author" itemscope itemtype="http://schema.org/Person">
                    ...
                    <span itemprop="name" class="author-name"><?php echo $qa_answer->author_name; ?></span>
                </span>
            </a>
                <?php  qa_user_badge( $qa_answer->post_author ); ?>
                <span itemprop="dateCreated" datetime="<?php echo $qa_answer->post_date; ?>" class="question-time">
