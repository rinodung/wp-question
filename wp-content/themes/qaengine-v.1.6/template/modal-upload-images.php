			...
			<div class="modal-body">
				<div class="upload-location" id="images_upload_container">
					...
					<div class="input-file">
						...
						?>
						<button <?php echo $disabled ?> id="images_upload_browse_button" onclick="return false;" class=""><?php _e("Browse",ET_DOMAIN);?></button>
                ...
                <div class="upload-url">
					...
					<!-- alt text -->
                    <span class="title"><?php _e( 'Alt text', ET_DOMAIN ) ?></span>
                    <div class="input-url">
